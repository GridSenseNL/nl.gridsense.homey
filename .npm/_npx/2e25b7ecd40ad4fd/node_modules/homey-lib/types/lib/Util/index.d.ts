...
declare namespace Util {
    export { FEATURE_SPEAKER, FEATURE_LED_RING, FEATURE_NFC, FEATURE_MATTER, FEATURE_CAMERA_STREAMING, FEATURE_BLE_ADVERTISEMENTS, _platformLocalFeatures, ZigbeeFirmwareUpdates, ZwaveFirmwareUpdates, ZigbeeFirmwareUpdateFile, ZwaveFirmwareUpdateFile };
}
...
declare var FEATURE_BLE_ADVERTISEMENTS: string;
